...
import { SendMessageComponent } from './whatsapp/send-message/send-message.component';
...
export const routes: Routes = [
  ...
  { path: 'whatsapp/send-message', component:SendMessageComponent , canActivate: [authGuard] },
